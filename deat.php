...
<body>
    ...
    include "nav.html";
    ?>
    <form method="post" action="" class="container d-flex">
        <div class="mb-3">
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="optional">
        </div>
        <div class="mb-3">
          <label for="exampleInputPassword1" class="form-label">Date of Certificate issued</label>
          <input type="date" class="form-control" id="exampleInputPassword1">
